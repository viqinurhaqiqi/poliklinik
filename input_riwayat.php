        ...
        <div class="container-fluid main-container">
            <div class="col-md-2 sidebar">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="input_riwayat.php"><i class="fa fa-stethoscope fa-lg"></i> Rekap Medis</a></li>
            ...
            <div class="col-md-10 content">
                <div class="panel panel-success" style="width: 76%">
                  <div class="panel-heading">Rekap Medis</div>
                  <div class="panel-body">
                    <a href="input_rekam.php" class="btn btn-sq-lg btn-primary" >
                        <i class="fa fa-pencil-square fa-5x"></i><br/><br>
                        INPUT REKAP<br> MEDIS
                    </a>
                    <a href="data_rekap.php" class="btn btn-sq-lg btn-info" >
                        <i class="fa fa-list fa-5x"></i><br/><br>
                        DATA REKAP<br> MEDIS
                    </a>
                    <a href="#" class="btn btn-sq-lg btn-danger">
                        <i class="fa fa-print fa-5x"></i><br/><br>
                        CETAK REKAP<br> MEDIS
                    </a><br><br><br>
                    <div class="col-md-6">
