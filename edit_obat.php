                ...
                <div class="panel panel-success" style="width: 76%;">
                  ...
                  <div class="panel-body">
                            <?php 
                                ...
                                $kode = $_GET['kode'];
                                $no = 1;
                                $q = $pdo->prepare("select * from obat where id_obat = '$kode'");
                                $q->execute();
                                $q->setFetchMode(PDO::FETCH_OBJ);
                                foreach ($q as $k => $v) {
                             ?>                                            
                                <form action="e_dataobat.php" method="POST">                                  
                                    <div class="form-group">                                                                   
                                        <label for="kode">ID Obat : </label>
                                        <input type="text" class="form-control" id="kode" style="width: 75%;" value="<?php echo $v->id_obat ?>" name="kode">
                                    </div>   
                                    <div class="form-group">
                                        <label for="nama_mhs">Nama obat : </label>
                                        <input type="text" class="form-control" id="nama" style="width: 75%;" value="<?php echo $v->nama_obat ?>" name="nama">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="stok" style="width: 75%;" name="stok" value="<?php echo $v->stok ?>">
                                    </div>
