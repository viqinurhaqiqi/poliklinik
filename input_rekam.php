            ...
            <div class="col-md-10 content">
                <div class="panel panel-success" style="width: 76%;">
                  ...
                  <div class="panel-body">
                                ...
                                <form action="p_inputrek.php" method="POST"> 
                                    <?php
                                        $q = $pdo->query("SELECT MAX(kode) as koderekam FROM rekap_medis");
                                        $datakode = $q->fetch(); 
                                        if($datakode) {
                                    ...
                                    <div class="form-group">
                                        <label for="kode_pasien">No.Berobat : </label>
                                        <input type="text" class="form-control" id="kode_pasien" style="width: 75%;" name="kode_pasien">
                                    </div>
                                    <div class="form-group">
                                        <label for="keluhan">Keluhan :</label>
                                        <textarea class="form-control" id="keluhan" name="keluhan" rows="5" style="width: 75%;"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="obat">Obat :</label>
                                        <select class="form-control" id="obat" name="obat" style="width: 75%;">
                                          <option>Pilih Obat</option>
                                          <?php
                                          
                                          // Buat query untuk menampilkan semua data siswa
                                          $q = $pdo->prepare("SELECT * FROM obat ORDER BY nama ASC");
