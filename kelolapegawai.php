            ...
            <div class="col-md-10 content">
                <div class="panel panel-success" style="width: 75%">
                    ...
                    <div class="panel-body">
                        <a href="input_dpegawai.php"><button class="btn btn-success">Tambah</button></a>
                        <a href="l_datapeg.php" target="_blank"><button class="btn btn-primary">Cetak Laporan</button></a><br><br>
                                        ...
                                        if(mysqli_num_rows($query) == 0){
                                            ...
                                            while($data = mysqli_fetch_assoc($query)){
                                                ...
                                                echo '<tr>';
                                                    ...
                                                    echo '<td><a href="edit_datapeg.php?kode='.$data['kode'].'" class="btn btn-warning">Edit</a>
                                                                <a href="h_datapeg.php?kode='.$data['kode'].'" onclick="return confirm(\'Anda yakin akan menghapusnya ?\')" class="btn btn-danger">Hapus</a></td>';
                                                echo '</tr>';
