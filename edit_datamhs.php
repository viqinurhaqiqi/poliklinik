                ...
                <div class="panel panel-success" style="width: 76%;">
                  ...
                  <div class="panel-body">
                            <?php 
                                ...
                                $kode = $_GET['kode'];
                                $no = 1;
                                $q = $pdo->prepare("select * from mahasiswa where kode = '$kode'");
                                $q->execute();
                                $q->setFetchMode(PDO::FETCH_OBJ);
                                foreach ($q as $k => $v) {
                             ?>                                            
                                <form action="e_datamhs.php" method="POST">                                  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nim" style="width: 75%;" value="<?php echo $v->nim ?>" name="nim">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="datepicker" style="width: 75%;" value="<?php echo $v->tgl_lahir ?>" name="tgl_lahir">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="alamat" value="<?php echo $v->alamat ?>" name="alamat" rows="5" style="width: 75%;"></textarea>
                                    </div> 
                                    <div class="form-group">
