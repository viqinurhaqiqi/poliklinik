                ...
                <div class="panel panel-success" style="width: 76%;">
                  ...
                  <div class="panel-body">
                            <?php 
                                ...
                                $kode = $_GET['kode'];
                                $no = 1;
                                $q = $pdo->prepare("select * from pegawai where kode = '$kode'");
                                $q->execute();
                            ...
                            <form action="" method="POST">                                  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="datepicker1" style="width: 75%;" value="<?php echo $v->no_hp ?>" name="no_hp">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Email : </label>
                                        <input type="text" class="form-control" id="datepicker1" style="width: 75%;" value="<?php echo $v->email ?>" name="email">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="datepicker1" style="width: 75%;" value="<?php echo $v->jabatan ?>" name="jabatan">
                                    </div>                                                                        
