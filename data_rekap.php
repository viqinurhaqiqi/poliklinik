            ...
            <div class="col-md-10 content">
                <div class="panel panel-success" style="width: 75%">
                    ...
                    <div class="panel-body">
                        <a href="input_rekam.php"><button class="btn btn-success">Input Rekap Medis</button></a>
                        <a href="l_datarekap.php" target="_blank"><button class="btn btn-primary">Cetak Laporan</button></a><br><br>
                        <table class="table table-striped table-bordered" id="data">
                         <thead>
                            ...
                            $query = mysqli_query($conn, "SELECT * FROM rekap_medis ORDER BY id ASC");
                            ...
                            if(mysqli_num_rows($query) == 0){
                                ...
                                while($data = mysqli_fetch_assoc($query)){
                                    ...
                                    echo '<tr>';
                                        ...
                                        // echo '<td><a href="?kode='.$data['kode'].'" onclick="return confirm(\'Anda yakin akan menghapusnya?\')" class="btn btn-danger">Cetak</a></td>';
                                    echo '</tr>';
